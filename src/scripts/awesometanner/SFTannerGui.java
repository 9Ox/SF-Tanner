...
import scripts.awesometanner.actions.ClickTanningInterface;
import scripts.awesometanner.actions.DepositEmptyVial;
import scripts.awesometanner.actions.DepositHides;
import scripts.awesometanner.actions.DrinkEnergyPotion;
import scripts.awesometanner.actions.OpenBank;
import scripts.awesometanner.actions.OpenTanningInterface;
import scripts.awesometanner.actions.TurnRunOn;
import scripts.awesometanner.actions.WalkToBank;
import scripts.awesometanner.actions.WalkToTanner;
import scripts.awesometanner.actions.WithdrawEnergyPotion;
import scripts.awesometanner.actions.WithdrawHides;
